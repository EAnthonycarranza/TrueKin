          ...
          <div className="checkout-form-column">
            <section className="card checkout-card"><h2 className="checkout-section-title"><span>01</span> How will you get your order?</h2>
              <div className="fulfillment-options">
                ...
                <label className={`fulfillment-option ${isPickup ? 'is-selected' : ''}`}><input type="radio" name="fulfillment" value="pickup" checked={isPickup} onChange={() => setMethod('pickup')} /><MapPin size={23} /><strong>Pick it up</strong><small>Free · Pay now or at pickup · We’ll coordinate</small></label>
              </div>
            </section>
