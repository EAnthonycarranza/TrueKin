...
export const CLIPART_CATEGORIES = [
  ...
  },
  {
    ...
    // `tone` + `altSrc` pair a mark with its authored opposite, so the studio can
    // swap Shield · Ink for Shield · Bone on a black tee instead of filtering the
    // artwork. Marks without a pair are left alone and warned about instead.
    name: 'Truekin',
    items: [
      { label: 'Shield · Ink', src: '/design-assets/brand/truekin-shield-ink.webp', thumbnail: '/design-assets/brand/thumbnails/truekin-shield-ink.webp', tone: 'dark', altSrc: '/design-assets/brand/truekin-shield-bone.webp' },
      { label: 'Shield · Bone', src: '/design-assets/brand/truekin-shield-bone.webp', thumbnail: '/design-assets/brand/thumbnails/truekin-shield-bone.webp', previewBackground: '#1b1b1b', tone: 'light', altSrc: '/design-assets/brand/truekin-shield-ink.webp' },
      { label: 'Logo · Ink', src: '/design-assets/brand/truekin-lockup-ink.webp', thumbnail: '/design-assets/brand/thumbnails/truekin-lockup-ink.webp', tone: 'dark', altSrc: '/design-assets/brand/truekin-lockup-bone.webp' },
      { label: 'Logo · Bone', src: '/design-assets/brand/truekin-lockup-bone.webp', thumbnail: '/design-assets/brand/thumbnails/truekin-lockup-bone.webp', previewBackground: '#1b1b1b', tone: 'light', altSrc: '/design-assets/brand/truekin-lockup-ink.webp' },
      { label: 'Eternal Knot', src: '/design-assets/brand/truekin-knot-ink.svg' },

      { label: 'Lockup · Black', src: '/design-assets/brand/truekin-lockup-black.webp', thumbnail: '/design-assets/brand/thumbnails/truekin-lockup-black.webp', tone: 'dark', altSrc: '/design-assets/brand/truekin-lockup-white.webp' },
      { label: 'Lockup · White', src: '/design-assets/brand/truekin-lockup-white.webp', thumbnail: '/design-assets/brand/thumbnails/truekin-lockup-white.webp', previewBackground: '#1b1b1b', tone: 'light', altSrc: '/design-assets/brand/truekin-lockup-black.webp' },
      ...
      { label: 'Weave · Ink', src: '/design-assets/brand/truekin-weave-ink.webp', thumbnail: '/design-assets/brand/thumbnails/truekin-weave-ink.webp', tone: 'dark', altSrc: '/design-assets/brand/truekin-weave-white.webp' },
      { label: 'Weave · White', src: '/design-assets/brand/truekin-weave-white.webp', thumbnail: '/design-assets/brand/thumbnails/truekin-weave-white.webp', previewBackground: '#1b1b1b', tone: 'light', altSrc: '/design-assets/brand/truekin-weave-ink.webp' },
